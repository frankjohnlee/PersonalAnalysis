...
class TestEnvironmentsTab:
    ...
    def test_bad_create(self, env_tab):  # analysis:ignore
        ...
        with open(tmpfile, 'w') as f:
            ...
            f.write(raw)
        worker = widget.packages_widget.import_yaml(name="navigatortest",
                                                    yaml=tmpfile)
    ...
    def test_ipython_option(self, env_tab, tmpfolder):
        ...
        qtbot.mouseClick(widget.list_environments.currentItem().button_options,
                         Qt.LeftButton)
        ...
        worker = widget.packages_widget.api.conda_install(name='navigatortest',
                                                          pkgs=['ipython'])
        worker.communicate()
        qtbot.mouseClick(widget.list_environments.currentItem().button_options,
                         Qt.LeftButton)
